...
function App() {
  ...
  function Pages() {
    return (
      <>
        {display === "home" && (
          <header className="header section sec1 active">
            <div className="header-contents">
              ...
              <div className="right-side">
                <div className="text-cont">
                  <h1>
                    Hello, My Name is
                    <span contenteditable="true" className="name">
                      {" "}
                      Richard Saturday <br />
                    </span>
                  ...
                  <p>
                    ...
                    CSS3, Javascript, React JS, MongoDB and progressive web
                    development.
                  </p>
                </div>
        ...
        <main className="main-container">
          {display === "about" && (
            <section className="section sec2 about active ">
                  ...
                  <div className="left-cont">
                    ...
                    <div>
                      <p>
                        ...
                        problem-solver with excellent communication and
                        teamwork. Adept at working on both small and large-scale
                        projects.
                        <br /> <br /> Therefore, these are my traits that
                        support human relations: <br />
                      </p>
                      ...
                      <ol>
                        ...
                        <li>Ability to meet targets and challenges.</li>
                        <li>I am jovial(friendly).</li>
                        <li>
                          Ability to learn fast with little or no supervision.
                        </li>
                      </ol>
                    </div>
                    <div className="btn-cont">
          ...
          {display === "portfolio" && (
            <section className="section sec3 portfolio active">
              <div className="main-title">
                <h2>
              ...
              <p className="port-text">
                Here are some of my works I have done in various programming
                languages.{" "}
              </p>
  ...
  const [theme, setTheme] = useState(
    JSON.parse(localStorage.getItem("Current_Theme")) ?? "light"
  );
